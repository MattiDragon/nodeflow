...
public class EditorMenu extends AbstractContainerMenu {
     ...
     * @param containerId The sync id of this screen handler, should be provided by minecraft for you.
     ...
     */
    public EditorMenu(int containerId, GraphProvider provider, ContainerLevelAccess context) {
        super(NodeFlow.SCREEN_HANDLER, containerId);
     ...
     */
    public EditorMenu(int containerId, Inventory inv, Graph graph) {
        super(NodeFlow.SCREEN_HANDLER, containerId);
        this.graph = graph;
    ...
    public boolean stillValid(Player player) {
        return this.context.evaluate((_, pos) -> player.distanceToSqr((double)pos.getX() + 0.5, (double)pos.getY() + 0.5, (double)pos.getZ() + 0.5) <= 64.0, true);
    }
