...
public class NodeFlowClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        if (FabricLoader.getInstance().isDevelopmentEnvironment()) {
            var debugEditorKey = KeyBindingHelper.registerKeyBinding(new KeyBinding("key.nodeflow.debug", GLFW.GLFW_KEY_K, "nodeflow"));
            var devKey = KeyBindingHelper.registerKeyBinding(new KeyBinding("key.nodeflow.dev", GLFW.GLFW_KEY_M, "nodeflow"));
